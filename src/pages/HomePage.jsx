  ...
  const featuredReviews = [
    {
      ...
      category: 'Hotel/Riad',
      image: riadImage,
      excerpt: 'An unforgettable experience in one of Marrakech\'s most iconic hotels...',
      date: '2 days ago'
    },
    {
      id: 2,
      ...
      category: 'Attraction',
      image: souksImage,
      excerpt: 'The main square comes alive at sunset with storytellers, musicians...',
      date: '1 week ago'
    },
    {
      id: 3,
      ...
      category: 'Restaurant',
      image: foodImage,
      excerpt: 'Traditional Moroccan cuisine elevated to an art form in this rooftop...',
      date: '2 weeks ago'
    },
  ];
  ...
  const latestArticles = [
    {
      ...
      readTime: '8 min read',
      image: souksImage,
      excerpt: 'Navigate the labyrinthine markets like a pro with our insider tips...'
    },
    {
      id: 2,
    ...
    },
    {
      ...
      image: foodImage,
      excerpt: 'Explore the rich flavors and spices that make Moroccan food unique...'
    },
  ];
      ...
      <section className="relative h-[600px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white max-w-4xl mx-auto px-4">
          ...
          <p className="text-xl md:text-2xl mb-8 text-gray-200">
            Your trusted guide to the best restaurants, hotels, attractions, and hidden gems 
            in Morocco's enchanting Red City
          </p>
                ...
                <Link key={index} to={category.href}>
                  <Card className="hover:shadow-lg transition-shadow cursor-pointer group">
                    <CardContent className="p-6 text-center">
                      <div className={`inline-flex items-center justify-center w-12 h-12 rounded-full mb-4 ${category.color} group-hover:scale-110 transition-transform`}>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {featuredReviews.map((review) => (
              <Card key={review.id} className="overflow-hidden hover:shadow-lg transition-shadow">
                ...
                <CardContent>
                  <p className="text-muted-foreground line-clamp-3">{review.excerpt}</p>
      ...
      <section className="py-16 bg-primary text-primary-foreground">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 opacity-90 max-w-2xl mx-auto">
            Help fellow travelers discover amazing places by sharing your reviews and experiences
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
